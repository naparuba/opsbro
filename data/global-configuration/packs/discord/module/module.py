...
from opsbro.compliancemgr import COMPLIANCE_STATE_COLORS, COMPLIANCE_STATES
...
def get_a_botclass(logger):
    ...
    class DiscoBot(commands.Bot):
        ...
        async def on_ready(self):
            ...
            await self._post_message('Loggued', 'Logged in as: %s / %s' % (self.user.name, self.user.id))
